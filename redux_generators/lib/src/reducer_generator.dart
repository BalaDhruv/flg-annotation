  ...
  generate(
    ...
    for (var element in library.allElements) {
      ...
      if (element is FunctionElement) {
        print('--------- inside reducer generator Accept children ----------');

        element.accept(
            visitor); // This will call visitFunctionElement in ModelVisitor
        print('--------- inside start reducer generator ----------');
        ...
        String returnState =
            visitor.reducers.first.functionReturnType.toString();
// define reducer
        buffer
            .writeln('final _\$$reducerName =combineReducers<$returnState>([');
        ...
        print('--------- inside End reducer generator ----------');
        return buffer.toString();
      }
    }
    print('--------- inside unimplemented reducer generator ----------');
